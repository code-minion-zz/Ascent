...
public class Circle : Shape2D
{
	...
	{
		Vector3 groundedPos = new Vector3(transform.position.x, 0.1f, transform.position.z);
		Handles.CircleCap(0, groundedPos + Offset, Quaternion.LookRotation(Vector3.down, Vector3.up), radius);
