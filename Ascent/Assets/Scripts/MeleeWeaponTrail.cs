...
public class MeleeWeaponTrail : MonoBehaviour
{
    ...
    public float fadeOutTimeMax = 1.0f;
    ...
    void Update()
    {
        ...
        if (timeElapsed > 0.0f)
        {
            ...
            Color[] newColor = new Color[_trailMesh.colors.Length];
            for(int i = 0; i < _trailMesh.colors.Length; ++i)
            {
                newColor[i] = _trailMesh.colors[i];
                newColor[i].a = timeElapsed;
            }

            _trailMesh.colors = newColor;
        }
