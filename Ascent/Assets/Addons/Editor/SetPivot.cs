...
public class SetPivot : EditorWindow
{
    ...
    [MenuItem("Mesh/Set Pivot")] //Place the Set Pivot menu item in the GameObject menu
    static void Init()
    {
            ...
            if (mesh)
            {
                ...
                { 
                    ...
                    if (pivotUnchanged)
                    {
                        ...
                        AssetDatabase.CreateAsset(mesh, mesh.name);
    ...
    void CreateNewMesh()
    {
        ...
        AssetDatabase.CreateAsset(m, "Assets/Meshes/" + m.name + "_copy" + ".asset");
        AssetDatabase.SaveAssets();
    }
